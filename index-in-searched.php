...
<html>
	...
	<body>
		...
		<header>
			...
			<!--图标-->
			<div class="icons">
				<a href=""><img src="icons/logined.png" width="30" height="30"></a>
		...
		<section class="review" id="review">
			...
			<div class="comment-container">
				<?php
					...
					$keyword=$_GET['keyword'];        //获取keyword
					
					$sql="select * from lyb where content like '%$keyword%'";
					
					$output=mysql_query($sql);          //得到符合搜索条件的记录的结果集
					echo mysql_error();
					
					if(mysql_num_rows($output)>0){
						echo "<p style='font-size:2.5rem;color:#666;'>关键字为: ".$keyword.",共找到".mysql_num_rows($output)."条记录</p>";
				
						if(mysql_num_rows($output)>0){        //结果集中记录数大于零时
				...
				<?php		} 
						...
						echo "<p style='font-size:2.5rem;color:#666;text-align:center'>未搜索到相关留言!</p>";
				?>
		...
		<script type="text/javascript">
			...
			/*菜单图标替换*/
			document.getElementById("menu-bar").onmouseover=function(){
				document.getElementById("menu").src="icons/menuhover.png";
			}
			
			document.getElementById("menu-bar").onmouseout=function(){
				document.getElementById("menu").src="icons/menu.png";
			}
